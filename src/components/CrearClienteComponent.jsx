...
class CrearClienteComponent extends Component {
    ...
    agregarActualizarCliente = (e) => {
        ...
        if (this.state.id === '_add') {
            ...
            ClienteService.actualizarCliente(cliente).then(respuesta => {
                this.props.history.push('/clientes');
            })
        }
    }
                            ...
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        <label>Nombres:</label>
                                        <input name="nombre" className="form-control" placeholder="Nombres completos"
                                               value={this.state.nombre} onChange={this.changeNombreHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Apellidos:</label>
                                        <input name="apellido" className="form-control" placeholder="Apellidos completos"
                                               value={this.state.apellido} onChange={this.changeApellidoHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>DNI:</label>
                                        <input name="dni" className="form-control" placeholder="DNI"
                                               value={this.state.dni} onChange={this.changeDniHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Celular:</label>
                                        <input name="celular" className="form-control" placeholder="Numero de celular"
                                               value={this.state.celular} onChange={this.changeCelularHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Email:</label>
                                        <input name="email" className="form-control" placeholder="Correo electronico"
                                               value={this.state.email} onChange={this.changeEmailHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Fecha Nacimiento:</label>
                                        <input name="fechaNacimiento" type="date" className="form-control"
                                               value={this.state.fechaNacimiento} onChange={this.changeFechaNacimientoHandler}/>
                                    </div>

                                    <button className="btn btn-success" onClick={this.agregarActualizarCliente}>
                                        Guardar
                                    </button>
